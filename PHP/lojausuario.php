            ...
            <?php
                ...
                else if(!empty($login))
                {
                   echo "<form id='conta' style='margin-top:10px' method='POST' action='contausuario.php'>                         
                            <input style='border: none; background: 0;' type='submit' value='$login'>  
                             | <img style='width:15px;height: 15px;' src='iconecarrinho.png'><input id='carrinho' type='submit' value='$qtditens'>                      
                        </form>";
                }
            ?>
        </ul>
